...
def _resolve_path(raw: str) -> Path:
    ...
    Supports shortcuts: 'desktop', 'downloads', 'documents', 'home', etc.
    Also handles paths like 'desktop/filename.txt'.
    """
    shortcuts = {
    ...
    lower = raw.lower()
    # Check if the path starts with a known shortcut + separator
    ...
    # Otherwise treat as normal path
...
def read_file(path: str, max_chars: int = 9000000000000000000000000) -> str:
