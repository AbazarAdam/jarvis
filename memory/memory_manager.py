...
def should_extract_memory(user_text: str, jarvis_text: str, api_key: str = "") -> bool:
    ...
    try:
        ...
        return response.get("success") and "YES" in response.get("text", "").upper()
    except Exception as e:
...
def extract_memory(user_text: str, jarvis_text: str, api_key: str = "") -> dict:
    ...
    prompt = (
        ...
        f"                  (e.g. J.A.R.V.I.S: 'Building a JARVIS-like AI assistant')\n"
        ...
        f' "projects":{{"J.A.R.V.I.S":{{"value":"JARVIS-like AI assistant"}}}},\n'
